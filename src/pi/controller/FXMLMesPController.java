 ...
 * @author dell
 */
public class FXMLMesPController implements Initializable {
                ...
                return new ListCell<Produit>() {
                    ...
                    protected void updateItem(Produit item, boolean bln) {
                        ...
                        if (item != null) {
                            ...
                            // Button button = new Button("Delete", new ImageView(imaged));
...
//liste.refresh();
 ObservableList<Produit> oblist = FXCollections.observableArrayList();
    ...
    private void mesProduits(ActionEvent event) throws IOException {
         Node source = (Node) event.getSource();
        Stage stage = (Stage) source.getScene().getWindow();
        Scene scene = new Scene(FXMLLoader.load(getClass().getResource("/pi/gui/FXMLLesP.fxml")));
        stage.setScene(scene);
    }
