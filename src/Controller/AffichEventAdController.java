...
public class AffichEventAdController implements Initializable {
    @FXML
    ...
    private void stat(ActionEvent event) throws IOException {
      ...
      Parent root2 = FXMLLoader.load(getClass().getResource("AffichEventAd.fxml"));
    ...
    private void Confirm(ActionEvent event) throws IOException {
      ...
      primary.show();
      Stage primaryStage=new Stage();
      Parent root = FXMLLoader.load(getClass().getResource("EventConfirm.fxml"));
      Scene scene = new Scene(root);    
      primaryStage.setTitle("Event Confirmation!");
      primaryStage.setScene(scene);
      primaryStage.show();
    }
