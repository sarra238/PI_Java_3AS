...
public class GmapsController implements Initializable, MapComponentInitializedListener {
    ...
    public void mapInitialized() {
        ...
        map = mapView.createMap(mapOptions);
           ...
           LatLong boutique_chicha  = new LatLong(35.764252, 10.811289);
        LatLong tapismargoum = new LatLong(47.6397, 10.0919243);
        LatLong jebba = new LatLong(36.8665367, 10.1647233);
        LatLong  verrerieartisana = new LatLong(35.824503, 10.634584);
        LatLong bois_artisana = new LatLong(33.7071551, 8.9714623);
        ...
        markerOptions1.position(boutique_chicha);
        
        MarkerOptions markerOptions2 = new MarkerOptions();
        markerOptions2.position(tapismargoum);
        
        MarkerOptions markerOptions3 = new MarkerOptions();
        markerOptions3.position(jebba);
        
        MarkerOptions markerOptions4 = new MarkerOptions();
        markerOptions4.position(verrerieartisana);
        
        MarkerOptions markerOptions5 = new MarkerOptions();
        markerOptions5.position(bois_artisana);
       ...
       // map.addMarker( ch );
        ...
        infoWindowOptions5.content("<h2> Chachia</h2>"
        ...
        infoWindowOptions1.content("<h2>bois artisanat</h2>"
                                + "Current Location: Safeway<br>"
                                + "ETA: 30 minutes" );
        ...
        infoWindowOptions3.content("<h2> tapis margoum</h2>"
                                + "Current Location: Safeway<br>"
                                + "ETA: 45 minutes" );
        ...
        infoWindowOptions4.content("<h2> jebba</h2>"
                                + "Current Location: Safeway<br>"
                                + "ETA: 15 minutes" );
        ...
        infoWindowOptions2.content("<h2>verrerie</h2>"
                                + "Current Location: Safeway<br>"
                                + "ETA: 20 minutes" );
